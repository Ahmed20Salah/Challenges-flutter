                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Spacer(),
                      Text('New Team', style: getBoldStyle(
                  ...
                  GestureDetector(
                    ...
                    child: logic.havePickImage == true
                      ...
                      decoration: BoxDecoration(
                          ...
                          FileImage(  File(logic.filePickImage!.path),),
                      ...
                      child :DottedBorder(
                        ...
                        child: Center(child: Icon(
                          Icons.add, color: Color(0xFFD1D7E4),)),
                      ),
                    ),
                  ),
                  ...
                  Text('Team Avatar', style: getRegularStyle(
                  ...
                  CustomElevatedButton(title: 'Create'.toUpperCase(),
                    titleFontStyle: getExtraBoldItalicStyle(
                        color: ColorManager.white, fontSize: 16.sp),onPressed: (){
                    logic.createTeam();

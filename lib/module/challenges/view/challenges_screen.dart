        ...
        switch (logic.rxRequestStatus.value) {
          ...
          case RequestStatus.SUCESS:
            return ListView.builder(
                itemCount:
                    logic.rxUserChallengesModel.value.userchallenges?.length ??
                        0,
                padding:
                    EdgeInsets.only(left: 26.w, right: 26.w, bottom: 120.h),
                itemBuilder: (context, index) {
                  return logic.getWidgetChallanges(
                      logic.rxUserChallengesModel.value.userchallenges?[index]);
                });
